...
CREATE TABLE IF NOT EXISTS logs (
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    logged_by BIGINT[] DEFAULT '{}'  -- Array of user IDs
);

CREATE INDEX IF NOT EXISTS idx_logs_created_at ON logs(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_logs_title ON logs USING gin(to_tsvector('english', title));
CREATE INDEX IF NOT EXISTS idx_logs_content ON logs USING gin(to_tsvector('english', content));
